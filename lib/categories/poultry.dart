...
class Poultry extends StatefulWidget {
  const Poultry({required this.title, Key? key}) : super(key: key);
  final String title;

  @override
  State<Poultry> createState() => _VeggiesPageState();
}

class _VeggiesPageState extends State<Poultry> {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text("No poultry available"));
          }
