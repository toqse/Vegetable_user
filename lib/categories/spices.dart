...
class Spices extends StatefulWidget {
  const Spices({required this.title, Key? key}) : super(key: key);
  final String title;

  @override
  State<Spices> createState() => _VeggiesPageState();
}

class _VeggiesPageState extends State<Spices> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('spices').snapshots(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text("No spices available"));
          }
