...
class _MyOrdersState extends State<MyOrders> {
  ...
  // Function to calculate the total price from all products in an order
  ...
  // Function to calculate the total quantity from all products in an order
  int calculateTotalQuantity(List<dynamic> products) {
    int total = 0;
    for (var product in products) {
      final quantity = product['quantity'] ?? 0;
      if (quantity is num) {
        total += quantity.toInt(); // Safely cast num to int
      }
    }
    return total;
  }
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Calculate total price and quantity using helper functions
              final double totalPrice = calculateTotalPrice(products);
